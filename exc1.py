...
if a < 0.7:
    ...
    print('Повышенный ровень стресса. Как у человека, у которого скоро сессия')
elif 6.9 <= a <= 8.0:
    print('Высокий уровень стресса. Как в том случае, когда не работает git')
elif a >= 10:
    print('Кажется, вы перенервничали. Вам нужен отдых!')